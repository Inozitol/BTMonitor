...
std::size_t defined_hash::operator()(const direct_flow_t& direct_flow) const{
...
direct_flow_t::direct_flow_t(const in_addr _ip_src,
...
direct_flow_t::direct_flow_t(const packet_data_t &pkt):
        direct_flow_t(pkt.ip_src, pkt.ip_dst, pkt.l4_p, pkt.l4_src, pkt.l4_dst){}

bidirectional_flow_key_t::bidirectional_flow_key_t(const direct_flow_t& directional_flow){
    std::size_t directional_flow_h = defined_hash()(directional_flow);

    direct_flow_t swaped_flow(directional_flow.ip_dst,
